...
public abstract class GenericJpaService<T, PK extends java.io.Serializable> {
	...
	protected final Object execute(JpaOperation operation, boolean transactional) throws PersistenceException {
		...
		JpaEnvironment jpaEnvironment = JpaEnvironmentProvider.getJpaEnvironment();
		if ( transactional ) {
	 ...
	 * @return
	 */
	public T merge(final T entityToSave) {
		// JPA operation definition 
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object execute(EntityManager em) throws PersistenceException {
	 ...
	 * @param primaryKey
	 */
	public boolean remove(final PK primaryKey) {
		// JPA operation definition 
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object execute(EntityManager em) throws PersistenceException {
	 ...
	 * @return
	 */
	public List<?> execNamedQuery(final String namedQuery) {
		// JPA operation definition 
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object execute(EntityManager em) throws PersistenceException {
	...
	/**
	 * Executes the given named query and returns its single result
	 * @param namedQuery
	 * @return the single result
	 */
	public Object execNamedQueryWithSingleResult(final String namedQuery) {
		// JPA operation definition 
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object execute(EntityManager em) throws PersistenceException {
